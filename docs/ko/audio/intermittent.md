...
Wallpaper Engine 설정의 "성능" 탭을 확인하세요. *"음소거"*를 설정하는 *"다른 응용 프로그램에서 오디오를 재생하고 있습니다"* 옵션이 있고 Wallpaper Engine이 계속 저절로 꺼졌다 켜지면, 화면과 배경화면의 사운드를 녹화하는 녹음 프로그램이 있을 수 있습니다.
