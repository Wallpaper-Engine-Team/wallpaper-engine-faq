...
::: warning
請注意 本文介紹音訊可視化工具無法運作的原因。 如果問題為音訊播放，請參見這份指南：

* [無音訊播放/音訊輸出問題](/audio/nosound)
:::


## 1. 音訊裝置設定
前往 Wallpaper Engine 設定後開啟「一般」分頁。 Towards the center you can find the "Media" section where you can select the **audio recording device**. 請確定已選取正確的裝置。 如果您不確定哪一個是正確的裝置，可邊聽音樂，邊確認所有可能的裝置，一直到音訊可視化工具開始運作。
