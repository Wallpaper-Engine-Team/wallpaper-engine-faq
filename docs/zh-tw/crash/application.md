...
如果重新安裝 Razer Synapse 也無法解決此問題，可能是因為 Razer Synapse 本身潛在的問題；以前曾因為 Razer Synapse 更新故障才導致此問題。 在 Wallpaper Engine 設定中的**外掛程式**關閉 LED 外掛程式 (*"iCUE & Chroma SDK"*)，等到未來 Razer Synapse 更新解決此問題後再啟用。
