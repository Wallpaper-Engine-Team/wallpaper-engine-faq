...
十分な知識がない状態でオーディオを録音することで、再生時に音の一時停止的を引き起こす可能性のある一般的なプロセス:

* **nvcontainer.exe**: オーディオ録音を行う可能性のあるNvidia GeForce Experienceの一部。 **Nvidia製のグラフィックカード使用時のみ関連があります。**
* **amdow.exe**: オーディオ録音を行う可能性のあるAMD ReLiveの一部。 ** AMD製のグラフィックカード使用時のみ関連があります。**
