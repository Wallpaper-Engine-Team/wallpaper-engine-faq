...
**Windows**アプリのユーザーインターフェース右上にある**モバイル** ボタンをクリックしてください。 モバイルデバイスの概要が表示されます。 デバイス概要の下部で、**新しいデバイスを接続** ボタンをクリックします。 Wallpaper Engineに、4桁のPINが表示されます。これを使って1台のモバイルデバイスとペアリングできます。
