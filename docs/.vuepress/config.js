	...
	themeConfig: {
		...
		locales: {
			'/es/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/es/', es.sidebar_windows, es.sidebar_crashes, es.sidebar_videos, es.sidebar_analysis, es.sidebar_audio, es.sidebar_performance, es.sidebar_nowshow, es.sidebar_browser, es.sidebar_downloads, es.sidebar_general),
				}
			},
			'/fr/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/fr/', fr.sidebar_windows, fr.sidebar_crashes, fr.sidebar_videos, fr.sidebar_analysis, fr.sidebar_audio, fr.sidebar_performance, fr.sidebar_nowshow, fr.sidebar_browser, fr.sidebar_downloads, fr.sidebar_general),
				}
			},
			'/ja/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/ja/', ja.sidebar_windows, ja.sidebar_crashes, ja.sidebar_videos, ja.sidebar_analysis, ja.sidebar_audio, ja.sidebar_performance, ja.sidebar_nowshow, ja.sidebar_browser, ja.sidebar_downloads, ja.sidebar_general),
				}
			},
			'/ko/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/ko/', ko.sidebar_windows, ko.sidebar_crashes, ko.sidebar_videos, ko.sidebar_analysis, ko.sidebar_audio, ko.sidebar_performance, ko.sidebar_nowshow, ko.sidebar_browser, ko.sidebar_downloads, ko.sidebar_general),
				}
			},
			'/pt/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/pt/', pt.sidebar_windows, pt.sidebar_crashes, pt.sidebar_videos, pt.sidebar_analysis, pt.sidebar_audio, pt.sidebar_performance, pt.sidebar_nowshow, pt.sidebar_browser, pt.sidebar_downloads, pt.sidebar_general),
				}
			},
			'/ru/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/ru/', ru.sidebar_windows, ru.sidebar_crashes, ru.sidebar_videos, ru.sidebar_analysis, ru.sidebar_audio, ru.sidebar_performance, ru.sidebar_nowshow, ru.sidebar_browser, ru.sidebar_downloads, ru.sidebar_general),
				}
			},
			'/th/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/th/', th.sidebar_windows, th.sidebar_crashes, th.sidebar_videos, th.sidebar_analysis, th.sidebar_audio, th.sidebar_performance, th.sidebar_nowshow, th.sidebar_browser, th.sidebar_downloads, th.sidebar_general),
				}
			},
			'/tr/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/tr/', tr.sidebar_windows, tr.sidebar_crashes, tr.sidebar_videos, tr.sidebar_analysis, tr.sidebar_audio, tr.sidebar_performance, tr.sidebar_nowshow, tr.sidebar_browser, tr.sidebar_downloads, tr.sidebar_general),
				}
			},
			'/zh/': {
			...
			'/zh-tw/': {
				...
				sidebar: {
					'/': getTopLevelSidebar('/zh-tw/', zhtw.sidebar_windows, zhtw.sidebar_crashes, zhtw.sidebar_videos, zhtw.sidebar_analysis, zhtw.sidebar_audio, zhtw.sidebar_performance, zhtw.sidebar_nowshow, zhtw.sidebar_browser, zhtw.sidebar_downloads, zhtw.sidebar_general),
				}
			},
			'/en/': {
