...
作为依赖锁屏的替代方法，我们建议将 Wallpaper Engine 设置为屏幕保护程序，并在 Windows 屏幕保护程序设置中启用**恢复时显示登录屏幕**选项。 See our screensaver guide on how to configure Wallpaper Engine as your screensaver:
