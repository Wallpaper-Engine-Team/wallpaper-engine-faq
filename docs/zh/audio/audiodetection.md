...
## 1. 音频设备设置
转到 Wallpaper Engine 设置，然后导航到“常规”选项卡。 Towards the center you can find the "Media" section where you can select an audio input device. Make sure the correct device is selected. If you are unsure which device is correct, try all possible devices while listening to music until the audio visualizers start working.
