...
Allez dans les paramètres de Wallpaper Engine et trouvez l'onglet "Général". Vers le centre, vous trouverez la section "Media" où vous pouvez sélectionner le **Dispositif d'entrée audio**. Assurez-vous que le bon périphérique est connecté. Assurez-vous que le bon périphérique est connecté. Si vous ne savez pas quel périphérique est le bon, essayez-les tous en écoutant de la musique jusqu'à ce que la visualisation fonctionne.
