...
* Убедитесь, что опции *интеграции с программным обеспечением* включены. Проверьте вкладку **«Устройства»**, чтобы убедиться, что все ваши аппаратные устройства поддерживают эту RGB-подсветку.
