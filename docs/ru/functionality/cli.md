...
Вы можете управлять Wallpaper Engine с помощью командной строки. Это позволит вам получить доступ к большинству функций приложения с помощью ярлыка, привязки макроса или любого вида самописного сценария или кода по вашему выбору. Например, вы можете приостановить или остановить все обои, изменить их или даже изменить настройки уже запущенных обоев.
...
* **location *(необязательно)*:** Внутренний идентификатор монитора. Вы можете найти их в файле config.json, которые генерируются вашим компьютером.
