...
* **playInWindow *(дополнительно)*:** Название окна, если вы хотите открывать/использовать в нем сразу несколько обоев. Название окна по умолчанию: Wallpaper Pop-out.
  ...
  * **borderless *(дополнительно)*:** Открыть окно без рамки.
