# Wallpaper Engine en Linux, Mac o Android
...
A pesar de que entendemos que los usuarios quieran que sea compatible con más sistemas operativos, no es una tarea sencilla. The core of Wallpaper Engine is a completely custom written software solution and the amount of work involved to fully port it to other platforms is enormous.
