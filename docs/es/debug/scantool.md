...
2. Elige la cuarta opción de Steam (*«Buscar aplicaciones conflictivas», abajo encontrarás un vídeo explicativo):
3. 3 Haz clic en **Guardar registro completo** y guárdalo en el escritorio (abajo encontrarás un vídeo explicativo).
4. 4 Comparte el registro con alguno de estos métodos:
