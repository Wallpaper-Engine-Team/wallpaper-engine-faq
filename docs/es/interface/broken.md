...
Si el problema persiste, cierra Wallpaper Engine Si el problema persiste, cierra Wallpaper Engine Vuelve a abrir Wallpaper Engine con la tercera opción de Steam «Interfaz de usuario en modo seguro».
